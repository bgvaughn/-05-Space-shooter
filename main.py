...
class Enemy(arcade.Sprite):
    def __init__(self, x, y, mass, hp):
        sprites = ['Sprites X2.spaceShips_001', 'Sprites X2.spaceShips_002', 'Sprites X2.spaceShips_003', 'Sprites X2.spaceShips_004', 'Sprites X2.spaceShips_005', 'Sprites X2.spaceShips_006', 'Sprites X2.spaceShips_007', 'Sprites X2.spaceShips_008', 'Sprites X2.spaceShips_009']
